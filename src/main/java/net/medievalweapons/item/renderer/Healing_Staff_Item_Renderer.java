...
public enum Healing_Staff_Item_Renderer {
    ...
    private final Healing_Staff_Entity_Model healing_Staff_Entity_Model = new Healing_Staff_Entity_Model(Healing_Staff_Entity_Model.getTexturedModelData().bakeRoot());
