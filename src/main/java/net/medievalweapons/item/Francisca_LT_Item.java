...
public class Francisca_LT_Item extends SwordItem {
    ...
    public Francisca_LT_Item(Tier toolMaterial, float attackDamage, float attackSpeed, Supplier<EntityType<Francisca_LT_Entity>> typeSupplier, Properties settings) {
